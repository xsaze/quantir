...
- `_project/docs/PRD.md` - Contains product requirements
...
Ignore all other files not relevant to the feature.
...
## Skills Required
<list skills from PROJECT-NAVIGATOR.md needed for this feature>

**General Skills**:
- `database-management` - <why needed for this feature>
- `api-design` - <why needed for this feature>
- `security` - <why needed for this feature>
- `testing` - <why needed for this feature>

**Specific Skills**:
- `<framework-skill>` - <why needed for this feature>

**Domain Skills**:
- `architecture-expert` - <why needed for this feature>
